...
export interface PopupPluginProps {
...
export type PopupViewProps = PopupPluginProps & {
  view: EditorView
}
...
export class PopupView {
  ...
  public shouldShow: Exclude<PopupPluginProps['shouldShow'], null> = ({ view, state, from, to }) => {
  ...
  constructor({ editor, element, view, tippyOptions = {}, shouldShow }: PopupViewProps) {
    this.editor = editor
...
export const PopupPlugin = (options: PopupPluginProps) => {
  return new Plugin({
    key: typeof options.pluginKey === 'string' ? new PluginKey(options.pluginKey) : options.pluginKey,
    view: view => new PopupView({ view, ...options }),
  })
}
