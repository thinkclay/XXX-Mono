...
function Bold({ editor }: Props) {
  ...
  return (
    <button onClick={handler}>
      <svg width="24" height="24" className="FillLayer" viewBox="0 0 27.346 27.346">
        <path
          className="FillLayer"
          d="M25.17,0.624H2.175C0.972,0.624,0,1.598,0,2.8v21.747c0,1.199,0.972,2.175,2.175,2.175H25.17
        ...
        <path
          className="FillLayer"
          d="M17.465,12.859v-0.048c1.832-0.712,2.684-2.052,2.684-3.495c0-1.514-0.803-2.639-1.951-3.249
