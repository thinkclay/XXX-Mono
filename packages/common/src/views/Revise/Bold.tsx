...
function Bold({ editor }: Props) {
    ...
    return (
        <button className={_active ? 'active' : ''} onClick={handler}>
            <svg width="24" height="24" className="FillLayer" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 27.346 27.346" >
                <g>
                    <g id="c157_bold">
                        <path  d="M25.17,0.624H2.175C0.972,0.624,0,1.598,0,2.8v21.747c0,1.199,0.972,2.175,2.175,2.175H25.17
			...
			H3.937c-1.018,0-1.838-0.826-1.838-1.837V4.48c0-1.013,0.82-1.837,1.838-1.837h19.438c1.014,0,1.838,0.824,1.838,1.837V22.867z"/>
                        <path  d="M17.465,12.859v-0.048c1.832-0.712,2.684-2.052,2.684-3.495c0-1.514-0.803-2.639-1.951-3.249
