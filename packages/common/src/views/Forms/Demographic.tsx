...
import { Modal, Select, Space, Typography, Button, Divider, Input } from 'antd'
...
const languageOptions = ['English', 'Spanish', 'Mandarin or Cantonese', 'Ignore/unknown']

const religionOptions = ['Hindu', 'Buddhist', 'Christian', 'Jewish', 'Muslim', 'Ignore/unknown']
  ...
  return (
    <>
      <div>
        ...
        >
          <p style={{ fontSize: 16 }}>
            Would you like to select the demographic categories for the subject/recipient of this email/document?
          </p>
        </Modal>
        <Modal
        ...
        >
          <Space style={{ width: '100%' }} direction="vertical">
            <Title style={{ margin: 0, fontWeight: 400 }} level={5}>
              {' '}
              Race/ethnicity
            </Title>
            <Select
              ...
              dropdownRender={menu => (
                <>
                  ...
                  <Space style={{ padding: '0 8px 4px' }}>
                    <Input placeholder="Please enter your race/ethnicity" ref={inputRef} value={name} onChange={onNameChange} />
            ...
            <Select
              ...
              dropdownRender={menu => (
                <>
                  ...
                  <Divider style={{ margin: '8px 0' }} />
                  <Space style={{ padding: '0 8px 4px' }}>
                    <Input placeholder="Please enter your language" ref={inputRef} value={name} onChange={onNameChange} />
                    <Button type="text" icon={<PlusOutlined />} onClick={addItem}>
                      Add item
                    </Button>
                  </Space>
            ...
            <Select
              ...
              dropdownRender={menu => (
                <>
                  ...
                  <Divider style={{ margin: '8px 0' }} />
                  <Space style={{ padding: '0 8px 4px' }}>
                    <Input placeholder="Please enter your religion " ref={inputRef} value={name} onChange={onNameChange} />
                    <Button type="text" icon={<PlusOutlined />} onClick={addItem}>
                      Add item
                    </Button>
                  </Space>
            ...
            <Select
              ...
              onChange={value => handleChange('IEP', value)}
              options={IEPOptions}
            />
            <Title style={{ margin: 0, fontWeight: 400 }} level={5}>
              Disability status
            ...
            <Select
              ...
              dropdownRender={menu => (
                <>
                  ...
                  <Divider style={{ margin: '8px 0' }} />
                  <Space style={{ padding: '0 8px 4px' }}>
                    <Input placeholder="Please enter your disability status" ref={inputRef} value={name} onChange={onNameChange} />
                    <Button type="text" icon={<PlusOutlined />} onClick={addItem}>
                      Add item
                    </Button>
                  </Space>
            ...
            <Select
              ...
              onChange={value => handleChange('housing', value)}
