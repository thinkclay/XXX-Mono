      ...
      <Flex direction="column" w="100%">
        <Flex direction={{ sm: 'column', lg: 'column', xl: 'row' }}>
          <Flex direction="column" me={{ lg: '40px', xl: '60px' }} mb={{ sm: '24px', lg: '0px' }}>
            ...
            >
              <Image src={currentImage} w="100%" h="100%" borderRadius="15px" alt="" />
            </Box>
          ...
          <Flex direction="column">
            ...
            <Text color="secondaryGray.600" pe={{ base: '0px', '3xl': '200px' }} mb="40px">
              Just consists of a shell made of molded ash or oak veneer and a steel or chrome frame. The frame is mounted to the seat by
              slotting seamlessly into the millings underneath the shell. The chairs are stackable, up to 6 pcs. The chair is delivered
              assembled.
            </Text>
            <Text textDecoration="line-through" color="secondaryGray.600" fontWeight="500" fontSize="md" lineHeight="100%">
              $590.00
            </Text>
            ...
            <Flex mb="50px" direction="column" w={{ base: 'fit', '2xl': '400px' }}>
              <SimpleGrid columns={{ md: 1, lg: 2 }} spacing="20px" w={{ base: 'fit', '2xl': '400px' }} mb="20px">
                <Flex direction="column" mb="14px">
                  <FormLabel ms="10px" htmlFor="color" fontSize="sm" color={textColor} fontWeight="bold" _hover={{ cursor: 'pointer' }}>
                    Color
                  </FormLabel>
                  <Select fontSize="sm" id="color" variant="main" h="44px" maxH="44px" fontWeight="400" me="20px" defaultValue="dark_grey">
                ...
                <Flex direction="column">
                  <FormLabel ms="10px" htmlFor="quantity" fontSize="sm" color={textColor} fontWeight="bold" _hover={{ cursor: 'pointer' }}>
                    Quantity
                  </FormLabel>
                  <Select
                    fontSize="sm"
            ...
            <Accordion defaultIndex={[0]} allowToggle w={{ sm: '100%', md: '100%', xl: '94%' }} mb="16px">
              <AccordionItem border="none">
                <AccordionButton p="20px 0px 20px 0px" borderBottom="1px solid" borderColor={borderColor}>
                ...
                <AccordionPanel p="18px 0px 10px 0px">
                  ...
                  >
                    ZOE™ is a simple and understated stackable shell chair with lots of personality and character that is as beautiful when
                    seen from below as from above. The frame is discretely tucked into the chair&#39;s molded shell, and the shell&#39;s
