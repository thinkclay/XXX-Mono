        ...
        <SimpleGrid columns={{ sm: 1, md: 2, lg: 2, xl: 2, '2xl': 4 }} gap="20px" mb="20px">
          ...
          <Flex>
            <Statistics
              ...
              illustration={<IconBox w="80px" h="80px" bg={iconBg} icon={<Icon color={iconColor} as={MdPerson} w="38px" h="38px" />} />}
            />
          </Flex>
          <Flex>
            <Statistics
              ...
              illustration={<IconBox w="80px" h="80px" bg={iconBg} icon={<Icon color={iconColor} as={MdFileCopy} w="28px" h="28px" />} />}
            />
          </Flex>
        </SimpleGrid>
