...
function SignUp() {
  ...
  const googleHover = useColorModeValue({ bg: 'neutral.200' }, { bg: 'whiteAlpha.300' })
  const googleActive = useColorModeValue({ bg: 'secondaryGray.300' }, { bg: 'whiteAlpha.200' })
  const [show, setShow] = React.useState(false)
  const handleClick = () => setShow(!show)
  return (
    <CenteredAuth cardTop={{ base: '140px', md: '14vh' }} cardBottom={{ base: '50px', lg: '100px' }}>
      <Flex
        maxW="max-content"
        mx={{ base: 'auto', lg: '0px' }}
        me="auto"
            ...
            <Flex justifyContent="space-between" align="center" mb="24px">
              <FormControl display="flex" alignItems="start">
                ...
                <FormLabel htmlFor="remember-login" mb="0" fontWeight="normal" color={textColor} fontSize="sm">
                  ...
                  <Link href="https://revisioned.org/terms-of-service" fontWeight="500">
                    Terms and Conditions,
                  </Link>{' '}
                  and our{' '}
                  <Link href="https://revisioned.org/privacy-policy" fontWeight="500">
                    Privacy Policy
                  </Link>
                </FormLabel>
              </FormControl>
