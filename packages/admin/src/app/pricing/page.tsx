        ...
        <Flex direction="column" alignSelf="center" justifySelf="center" overflow="hidden">
          <Flex direction="column" textAlign="center" justifyContent="center" align="center" mb="38px">
            ...
            <Text zIndex="1" fontSize="md" color="white" fontWeight="normal" mt="10px" mb="26px" maxW="400px">
              See our pricing plans for all Premium and Free products & templates. Try the ReVision Dashboard
            </Text>
            <Badge
              w="max-content"
            ...
            <Flex direction="column" mb="160px" justify="center" align="center">
              <Text
                ...
                textAlign="center"
              >
                More than 25,000 users use ReVision
              </Text>
              <SimpleGrid columns={{ sm: 2, md: 3, lg: 6 }} spacingX={{ sm: '65px', lg: '40px', xl: '65px' }} spacingY={{ sm: '30px' }}>
                <Image src={googleLogo} alignSelf="center" justifySelf="center" alt="" />
                <Image src={msnLogo} alignSelf="center" justifySelf="center" alt="" />
                <Image src={microsoftLogo} alignSelf="center" justifySelf="center" alt="" />
                <Image src={zohoLogo} alignSelf="center" justifySelf="center" alt="" />
                <Image src={georgiaLogo} alignSelf="center" justifySelf="center" alt="" />
                <Image src={deloitteLogo} alignSelf="center" justifySelf="center" alt="" />
              </SimpleGrid>
            </Flex>
              ...
              <Box>
                <Box mb="60px">
                  ...
                  <Text textAlign="start" color="secondaryGray.600" fontWeight="500" fontSize="md">
                    These products are not Wordpress themes, however, they can be integrated in Wordpress by an experienced web developer.
                  </Text>
                </Box>
                <Box mb="60px">
                  <Text textAlign="start" color={textColor} fontWeight="500" fontSize="2xl" mb="12px">
                ...
                <Box mb="60px">
                  ...
                  <Text textAlign="start" color="secondaryGray.600" fontWeight="500" fontSize="md">
                    It means that each theme within the Exclusive Digital Bundle promotion has a thorough and up to date documentation on
                    how to get started with the product and each components and plugin is properly explained.
                  </Text>
                </Box>
              </Box>
              <Box>
                <Box mb="60px">
                  ...
                  <Text textAlign="start" color="secondaryGray.600" fontWeight="500" fontSize="md">
                    Yes, they are. Each theme has a html&css folder which contains the theme with classic HTML, CSS, and Javascript files.
                  </Text>
                </Box>
                <Box mb="60px">
                  <Text textAlign="start" color={textColor} fontWeight="500" fontSize="2xl" mb="12px">
                  ...
                  <Text textAlign="start" color="secondaryGray.600" fontWeight="500" fontSize="md">
                    In case you have already purchased a license, but you want to upgrade, you can just send us a message using the contact
                    page and we will send you a discount code so you will only pay the difference for the upgrade.
                  </Text>
                </Box>
                <Box mb="60px">
                  <Text textAlign="start" color={textColor} fontWeight="500" fontSize="2xl" mb="12px">
