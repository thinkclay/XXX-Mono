/* eslint-disable */
// Chakra Imports
import { Box, Button, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Flex, Link, useColorModeValue } from '@chakra-ui/react'
...
export default function AdminNavbar(props: {
  ...
  let secondaryText = useColorModeValue('neutral.700', 'white')
