...
export default function Default(props: { image: string; name: string; type: 'PRO' | 'free'; date: string; pack: string; version: string }) {
    ...
    <Card p="20px">
      <Flex direction={{ base: 'column', '2xl': 'row' }}>
        <Image
          ...
          alt=""
        />
        <Flex flexDirection="column" h="100%" align={{ base: 'center', xl: 'start' }} justify={{ base: 'center', xl: 'center' }}>
