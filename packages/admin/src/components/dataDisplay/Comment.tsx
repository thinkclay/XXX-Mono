...
export default function Comment(props: { avatar: string; name: string; text: string; tags?: string[]; time: string; [x: string]: any }) {
  ...
  return (
    <Flex mb="30px" {...rest}>
      <NextAvatar src={avatar} w="50px" h="50px" me="15px" style={{ flexShrink: '0' }} />
