  ...
  return (
    ...
    >
      <Flex
        ...
        zIndex="1"
      >
        <SearchBar w={{ base: '100%', md: '292px' }} placeholder="Search your next destination" bg={inputBg} mb="auto" />
        <Flex
          w="100%"
          mt={{ base: '12px', md: '0px' }}
        ...
        >
          ...
          >
            ...
            <Flex w="100%" direction="column" me={{ base: '20px', md: '40px' }}>
              <Flex mb="50px" w={{ base: '100%', md: '100%' }} h="max-content" zIndex="2">
                <Box me="14px" border="3px solid" borderColor={brand} bg={inputBg} h="16px" w="16px" borderRadius="50%" />
          ...
          <Button
            ...
            variant="no-hover"
          >
            <Icon as={IoPaperPlane} color="secondaryGray.700" w={{ base: '18px', md: '25px' }} h={{ base: '18px', md: '25px' }} />
          </Button>
        </Flex>
      </Flex>
      <Map
