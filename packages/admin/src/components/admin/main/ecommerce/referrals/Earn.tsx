...
export default function Conversion(props: { [x: string]: any }) {
  ...
  const completeShadow = useColorModeValue('0px 18px 40px rgba(112, 144, 176, 0.12)', 'inset 0px 4px 4px rgba(255, 255, 255, 0.2)')
  ...
  return (
    <Card p="30px" w="100%" {...rest}>
      ...
      <Text color="secondaryGray.600" fontSize="md" fontWeight="400" mb="70px">
        Invite your friends to ReVision, if they sign up, you and your friend will get 2 premium features for free!
      </Text>
      <Flex position="relative" direction={{ base: 'column', md: 'row' }} justifyContent="center">
        ...
        <Flex direction="column" align="center" justify="center">
          ...
          <Text textAlign="center" color="secondaryGray.600" fontSize="md" fontWeight="400" maxW="278px" mb="70px">
            Send your referral link to friends and tell them how useful ReVision is!
          </Text>
        </Flex>
        ...
        <Flex direction="column" align="center" justify="center">
          ...
          />
          <Text textAlign="center" color={textColor} fontSize="xl" fontWeight="700" mb="10px">
            Use ReVision for Free!
          </Text>
          <Text textAlign="center" color="secondaryGray.600" fontSize="md" fontWeight="400" maxW="278px" mb="70px">
            You and your friends get 2 premium ReVision features for free!
          </Text>
        </Flex>
      </Flex>
    </Card>
