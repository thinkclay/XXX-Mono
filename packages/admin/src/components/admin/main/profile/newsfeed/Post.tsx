...
import { MdBookmarkBorder, MdImage, MdOutlineAttachment, MdOutlineFavoriteBorder, MdOutlineTagFaces, MdShare } from 'react-icons/md'
    ...
    <Card p={{ base: '15px', md: '30px' }} {...rest}>
      <Box mb="45px" w="100%">
        <Flex justify="space-between" align="center" w="100%">
          <Flex>
            <SeeStory action={() => console.log('Story seen!')} ps="0px" avatar={avatar} w="40px" h="40px" borderRadius="12px" />
      ...
      <Flex direction="column">
        <AspectRatio width={'100%'} ratio={567 / 352}>
          <Image src={image} minW={{ sm: '270px' }} h="auto" borderRadius="16px" mb="30px" alt="" />
        </AspectRatio>
        <Box px={{ md: '20px' }} mt={'30px'}>
          ...
          <Flex align="center" position="relative">
            <NextAvatar display={{ base: 'none', md: 'unset' }} src={you} w="50px" h="50px" me="15px" />
            <Input
              variant="social"
