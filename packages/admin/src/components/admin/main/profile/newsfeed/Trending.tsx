'use client'
// Chakra imports
import { AspectRatio, AvatarGroup, Box, SimpleGrid, Text, useColorModeValue } from '@chakra-ui/react'
    ...
    <Card height="max-content" {...rest}>
      ...
      <SimpleGrid columns={3} mb="40px" gap="8px">
        <Link href="#">
          <AspectRatio w={'100%'} ratio={10 / 9}>
            <Image h={'100%'} w={'100%'} borderRadius="8px" src={image1} alt="" />
          </AspectRatio>
        </Link>
        <Link href="#">
          <AspectRatio w={'100%'} ratio={10 / 9}>
      ...
      <Box borderRadius="20px" bg={boxBg} p="30px">
        <AvatarGroup flexWrap="wrap" mb="20px">
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar1} />
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar2} />
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar3} />
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar4} />
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar5} />
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar6} />
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar7} />
          <NextAvatar h="42px" w="42px" border="3px solid" borderColor={boxBg} src={avatar8} />
          <NextAvatar h="44px" w="44px" border="3px solid" borderColor={boxBg} src={avatar9} />
        </AvatarGroup>
