  ...
  return (
    <Card {...rest} maxH="max-content">
      ...
      <Text color={textColor} fontSize="md" fontWeight="400" mb="50px">
        You’ll learn to have a powerful Instagram account setup for your Business or personal that you can build your brand and convert your
        followers into paying customers, how to attract 20,000 real followers to your account and how to convert your new Instagram
        followers to long-term loyal paying customers who love your business!
      </Text>
      <Text color={textColor} fontSize="xl" fontWeight="700" mb="16px">
        By the numbers
      </Text>
