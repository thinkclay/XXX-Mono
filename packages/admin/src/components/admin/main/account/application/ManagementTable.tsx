...
export default function LastOfferTable(props: { tableData: any }) {
  ...
  const columns = [
    columnHelper.accessor('name', {
      ...
      cell: (info: any) => (
        <Flex align="center">
          <Avatar src={info.getValue()[2]} w="36px" h="36px" me="8px" borderRadius="14px" />
    ...
    columnHelper.accessor('edit', {
      id: 'edit',
      header: () => <Text justifyContent="space-between" align="center" fontSize={{ sm: '10px', lg: '12px' }} color="neutral.400"></Text>,
      cell: info => (
  ...
  return (
    <Card>
      <Flex direction="column" w="100%" overflowX={{ sm: 'scroll', lg: 'hidden' }}>
        ...
        <Box>
          <Table variant="simple" color="neutral.500" mt="12px">
            <Thead>
