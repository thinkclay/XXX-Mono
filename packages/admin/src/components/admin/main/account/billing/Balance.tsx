'use client'
// Chakra imports
import { Flex, Icon, Text, useColorModeValue, Menu, MenuButton, MenuItem, MenuList, useDisclosure } from '@chakra-ui/react'
...
export default function Balance(props: { [x: string]: any }) {
  ...
  return (
    <Card flexDirection="column" w="100%" {...rest}>
      <Flex justify="space-between" p="16px" mb="20px" borderRadius="16px" bgColor={balanceBg} bgImage={balanceImg?.src} bgSize="cover">
