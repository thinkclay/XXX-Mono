    ...
    <FormControl>
      <Card mb="20px" {...rest}>
        ...
        <SimpleGrid columns={{ sm: 1, md: 2 }} spacing={{ base: '20px', xl: '20px' }}>
          <InputField mb="0px" me="30px" id="username" label="Username" placeholder="@revisioned.org" />
          <InputField mb="0px" id="email" label="Email Address" placeholder="hello@revisioned.org" />
        ...
        <TextField id="about" label="About Me" h="100px" placeholder="Tell something about yourself in 150 characters!" />
      </Card>
    </FormControl>
  )
}
