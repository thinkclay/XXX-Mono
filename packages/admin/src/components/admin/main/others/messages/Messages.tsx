  ...
  return (
    <Box h="100%" {...rest}>
      <Flex px="34px" pb="25px" borderBottom="1px solid" borderColor={borderColor} align="center">
        <Avatar h={{ base: '40px', '2xl': '50px' }} w={{ base: '40px', '2xl': '50px' }} src={avatar2.src} me="16px" />
        <Box>
          ...
          <Flex align="center">
            ...
            />
            <Text fontSize={{ base: 'sm', md: 'md' }}>{status === 'active' ? 'Active' : status === 'away' ? 'Away' : 'Offline'} </Text>
          </Flex>
        </Box>
        ...
        >
          <Flex overflow="hidden">
            <Flex direction="column" w="100%" maxW={{ base: '90%', lg: 'calc(100% - 80px)' }} boxSizing="border-box">
              ...
              <MessageBlock
                content="I saw an amazing dashboard called ReVision by Unicorn 🦄, I want to know what you think about it, because I like it so much! 😁"
                time="09:00 PM"
                side="left"
              />
              <MessageBlock
                content={
                  <span>
                    ...
                    <Link color={brandColor} target="_blank" href="https://horizon-ui.com/chakra-pro/?ref=comments-page">
          ...
          <Flex mb="50px" overflow="hidden" w="94%" ms="auto" justify="end">
            ...
            >
              ...
              <MessageBlock
                ...
                seen
                content={
                  <span>OMG!! It’s so innovative and awesome! I think I am going to buy it for my projects! It’s a game changer!!🔥</span>
                }
                time="09:25 PM"
              />
            </Flex>
