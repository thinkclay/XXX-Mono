'use client'
// Chakra imports
import { AspectRatio, Flex, Icon, Text, useColorModeValue } from '@chakra-ui/react'
    ...
    <Flex mb={{ base: '20px', '2xl': '20px' }} justifyContent="center" align="center" direction="column" w="100%">
      ...
      <Card maxW="100%" w="800px" py="40px" mb="40px">
        <Flex w="100%" justify="center" direction={{ base: 'column', md: 'row' }}>
          ...
          <VSeparator />
          <Flex direction="column" align="center" mx={{ base: '0px', md: '30px', lg: '60px' }} mb={{ base: '20px', md: '0px' }}>
