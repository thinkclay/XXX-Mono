...
export default function Auction(props: { name: string; price: string; creator: string; creatorAvatar: string; bid: number }) {
  // Chakra Color Mode
    ...
    <Flex direction="column" ps={{ base: 'unset', lg: "'65px'" }} mx="auto" maxW={{ base: '100%', md: 'max-content' }}>
      ...
      <Flex>
        <Flex mt="55px" mb="36px" me="auto" justifyContent="center" alignItems="center">
          <NextAvatar h={{ base: '40px', md: '60px' }} w={{ base: '40px', md: '60px' }} src={creatorAvatar} me="20px" />
          <Box>
        ...
        <Flex mt="75px" mb="56px" justifyContent="center" alignItems="center">
          <Flex
            ...
            align="center"
          >
            <Icon as={MdOutlineMonetizationOn} h={{ base: '25px', md: '38px' }} w={{ base: '25px', md: '38px' }} color="white" />
          </Flex>
          <Box>
            <Text color="secondaryGray.600" fontSize="md" fontWeight="500">
              Instant price
      ...
      >
        ...
        <Text fontWeight="700" color={textColor} fontSize={{ base: '48px', md: '54px', xl: '64px' }} my="10px" lineHeight="100%">
          {bid} ETH
        </Text>
