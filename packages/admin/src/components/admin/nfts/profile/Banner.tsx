'use client'
// Chakra imports
import { AspectRatio, Flex, Icon, Text, useColorModeValue, useToast } from '@chakra-ui/react'
import { NextAvatar } from 'components/images/Avatar'
import { Image } from 'components/images/Image'
// Assets
import { MdOutlineContentCopy, MdVerified } from 'react-icons/md'

export default function Banner(props: { image: string; address: string; name: string; wallet: string; date: string; profile: string }) {
  ...
  return (
    <Flex justifyContent="center" align="center" direction="column" w="100%">
      ...
      <Text color={textColor} fontSize="lg" fontWeight="500" lineHeight="180%" w="860px" maxW="100%" textAlign="center" mb="60px">
        {date}
      </Text>
    </Flex>
  )
